...
2. regenerates the Android launcher icons from `assets/icons` (see the
   *App icon* note below),
3. stamps the app version from the tag (`1.2.1` becomes `versionCode`
...
5. attaches both to the GitHub Release for the tag, with the version
   embedded in the filename (e.g. `Darya-1.2.1-release.aab` and
   `Darya-1.2.1-release.apk`).
