...
(function (global) {
  ...
  global.DaryaFactChunks.push([
    ...
    },
    {
      ...
      weak: ['خرید', 'خریدم', 'قیمت', 'shopping', 'price'],
      weakSafe: true,
    ...
    },
    {
      ...
      weak: ['دیجی کالا', 'digikala', 'torob', 'divar', 'sheypoor', 'شیپور'],
      // Not weakSafe: the Persian spellings «ترب» (radish) and «دیوار»
      // (wall) are everyday nouns, so these weaks need a purchase hint
      // before they can carry the marketplace answer.
      weakSafe: false,
      hints: [
        'خرید',
        'قیمت',
