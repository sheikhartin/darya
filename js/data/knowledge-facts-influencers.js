...
(function (global) {
  ...
  global.DaryaFactChunks.push([
    ...
    },
    {
      ...
      fa: 'کریستیانو رونالدو فوتبالیست پرتغالی است که با گلزنی بی‌وقفه، آمادگی بدنی و اخلاق حرفه‌ای به یکی از بهترین‌های تاریخ فوتبال تبدیل شد. در منچستریونایتد، رئال مادرید و یوونتوس بازی کرده و از ۲۰۲۳ در باشگاه النصر عربستان توپ می‌زند (تا عکس دانش من در ۲۰۲۶) و رکوردهای گلزنی ملی و باشگاهی زیادی دارد. به‌خاطر نظم تمرین و طول عمر ورزشی‌اش الگوی بسیاری از ورزشکاران است.',
      en: 'Cristiano Ronaldo is a Portuguese footballer who became one of the greatest in history through relentless goal-scoring, physical conditioning, and professionalism. He has played for Manchester United, Real Madrid, and Juventus, and since 2023 for Saudi club Al-Nassr (as of my 2026 snapshot), holding many club and national scoring records. His training discipline and sporting longevity make him a model for many athletes.',
      record: {
