  ...
  global.DaryaFactChunks.push([
    {
      ...
      keywords: [
        ...
        '2028',
        'jobs in 2028',
        // The 2033 probes («توی سال ۲۰۳۳ چه شغل‌هایی هست», "what jobs
        // will exist in 2033") are the same future-horizon question as
        // 2026-2030, so the decade variants route to the same shelf.
        '2033',
        'jobs in 2033',
        'jobs by 2033',
        'jobs in 2035',
        ...
        'شغل‌های آینده',
        'شغل های آینده',
        'بهترین رشته برای آینده',
        'چه رشته‌ای بخونم',
        'چه رشته بخونم',
        'چه بخونم',
        // Security careers are a concrete sub-field of the AI/tech story;
        // the probe "is cybersecurity a good career" previously bounced
        // to the philosophy shelf because no keyword matched.
        'cybersecurity',
        'cyber security',
        'security career',
