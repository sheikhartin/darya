...
(function (global) {
  ...
  const blendResponses = {
    ...
    blend_food_joy: ['Eating with pleasure can become a really nice moment.', 'Enjoying good food can be a small celebration.', 'Taking pleasure in food is a way of caring for yourself.', 'A good meal can sometimes brighten the whole day.'],
    blend_hobby_joy: ['When you enjoy something, it is like finding a part of yourself.', 'Hobbies that make us happy are valuable.', 'It is good to have something that lifts your mood.', 'These moments of enjoyment are worth holding on to.'],
    blend_weather_sadness: ['Sometimes the weather seems to match how we feel. It is okay.', 'Cloudy days can make sadness feel heavier. That is natural.', 'Maybe today is a good day to be a little gentler with yourself.', 'The weather always changes, but for now we can sit with it.'],
  };
