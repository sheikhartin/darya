...
(function (global) {
  ...
  const en = {
    ...
    ui: {
      ...
      exportYouLabel: 'You',
      exportDivider: '-----------------------------',
      exportSavedNotice: 'Saved to the Downloads folder.',
      exportSavedAppFilesNotice: 'Saved to the app folder on this device.',
      exportCopiedNotice: 'Transcript copied to the clipboard.',
      exportFailedNotice: 'Could not save the conversation.',
      dateLocale: 'en-US',
