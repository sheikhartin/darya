...
(function (global) {
  ...
  const rules = [
    rule(
      ...
      pw(
        'خودکشی|خودزنی|آسیب زدن به خودم|به خودم (?:صدمه|آسیب) (?:بزنم|بزنمش|میزنم|میزنمش|بزنمش)|(?:می‌خوام|میخوام|می خوام|دلم می‌خواد|دلم میخواد|دلم می خواد).{0,10}(?:خودمو بکشم|خودمو بکشمش|به خودم (?:صدمه|آسیب) بزنم|زندگیم رو تموم کنم|زندگیمو تموم کنم|پایان بدم)|نمی‌?خوام (?:زنده بمونم|زنده باشم|ادامه بدم)|نمیخوام (?:زنده بمونم|زنده باشم|ادامه بدم)|دیگه نمیخوام (?:زندگی کنم|زنده باشم|زنده بمونم)|دیگه نمی‌خوام (?:زندگی کنم|زنده باشم|زنده بمونم)|دیگه نمی خوام (?:زندگی کنم|زنده باشم|زنده بمونم)|دلیلی برای زندگی ندارم|دلیلی برای زنده موندن ندارم|دلیلی برای زنده‌ماندن ندارم|دلم میخواد بمیرم|دلم می‌خواد بمیرم|نمیخوام دیگه باشم|نمی‌خوام دیگه باشم|میخوام به زندگیم پایان بدم|می‌خوام به زندگیم پایان بدم|به زندگیم پایان بدم|به زندگیم خاتمه بدم|دیگه طاقت ندارم زندگی کنم|دیگه طاقت ندارم|میخوام بمیرم|می‌خوام بمیرم|خودمو (?:حلق آویز|حلق‌آویز|دار) (?:کنم|بزنم)|حلق آویز کنم|خودمو خلاص کنم|خودمو بکشم|خودمو از بین ببرم|خودمو نابود کنم|کاش (?:می‌مردم|میمردم|بمیرم|مرده بودم)|کاش دیگه نبودم|بهتره (?:که )?دیگه نباشم|بهتره بمیرم|(?:همه|تمام) قرص(?:‌| )?هامو خوردم|قرص جمع (?:کردم|میکنم|می‌کنم)|قرص خوردم که بمیرم|رگمو (?:بزنم|زدم)|رگ دستمو (?:بزنم|زدم)|از (?:پشت بوم|پل|ساختمون) (?:بپرم|پرت شم)|میخوام بپرم پایین|بخوابم و دیگه بیدار نشم|دیگه بیدار نشم|بدون من (?:همه )?راحت(?:تر| تر)?ن|بدون من بهتره|زندگیم ارزش(?:ی)? نداره|مردنم بهتره|کاش (?:نمیبودم|نمی بودم|نبودم|نبود)|بهتر بود (?:که )?(?:اگه )?(?:نمیبودم|نمی بودم|نبودم)|بهتره (?:که )?نبودم|(?:مرگ|مردن) (?:راحت تره|راحت‌تره|راحتتره|راحت تر است|راحت‌تر است|آسون تره|آسون‌تره|آسونتره|آسون تر است|آسون‌تر است|بهتره|بهتر است)|(?:همه|تمام) قرص(?:‌هام|ام|هایم|ها|م)? (?:رو|را)? ?(?:همه )?(?:رو|را)? ?خوردم|قرص(?:‌| )?(?:خوابم|خواب‌هام|خوابام|خوابم|خواب)? ?(?:م|ها)? ?(?:رو|را) (?:همه|تمام) (?:رو|را)? ?خوردم|(?:اووردوز|اوردوز|اور دوز) کردم|جون(?:م)? (?:رو )?نمیخوام|جون(?:م)? نمیخوام|دیگه جون(?:م)? نمیخوام|راحت(?:تون|ت)? میکنم و میرم|خسته(?:م|‌ام| ام) از زندگی|از زندگی خسته(?:م|‌ام| ام)|برای همیشه خداحافظی|خداحافظی(?:م)? برای همیشه|به مردن فکر می ?کنم|به مردن فکر میکنم|اگه بیدار نشم مشکلی ندارم|اگه بیدار نشم مشکلی نداره|همه اگه نباشم راحت ?ترن|همه اگه نباشم راحتترن|خانواده ?م? بدون من بهترن|از زنده بودن خسته شدم|از زنده بودن خسته ?ام|مردن آرومه و راحته|مردن راحته|هیچ چیز برام معنی نداره'
      ),
      R['ruleSafety']
    ),
    ...
    rule(
      ...
      101,
      pw(
        '(?:دوستم|خواهرم|برادرم|داداشم|آبجیم|مامانم|بابام|پسرم|دخترم|همکارم|هم اتاقیم|همسرم|شوهرم|زنم|نامزدم|پارتنرم|رفیقم).{0,30}(?:میخواد خودکشی کنه|می‌خواد خودکشی کنه|حرف از خودکشی|فکر خودکشی|خودزنی میکنه|خودزنی می‌کنه|به خودش آسیب میزنه|به خودش آسیب می‌زنه|میخواد بمیره|می‌خواد بمیره|تهدید به خودکشی|خودشو بکشه|خودش رو بکشه|میخواد خودشو بکشه|حرف(?:ی)? از خودکشی زد|از پشت بوم بپره|پشت بوم (?:بپره|پرت شه)|حرف زدن از مردن)'
      ),
    ...
    rule(
      ...
      // suffix), so the pattern carries that spaced form. The affection
      // word (جان/عزیزم/...) is allowed BOTH before and after the check-in
      // word, because Iranians naturally type «سلام عزیزم خوبی؟» and
      // «درود جان چطوری؟» as often as «سلام خوبی جان؟»; the previous
      // pattern only accepted the tail position, which sent those warm
      // openers to the ambiguous pool. The check-in set also covers
      // «خوب هستی؟» (the polite/formal counterpart of «خوبی؟»),
      // «احوالت چطوره»/«احوال شما چطوره», «خوشی؟», «چطوراتی», and
      // «اوضاع چطوره» - everyday variants real users type. The curiosity
      // prefix «دوست دارم بدونم ...» / «می‌خوام بدونم ...» is allowed
      // before the check-in word, because «دوست دارم بدونم حالت چطوره»
      // is a warm how-are-you, not a romantic confession or a knowledge
      // question. The affectionate word (جان/عزیزم/...) may sit either
      // between the greeting and the check-in («سلام عزیزم خوبی؟») or
      // after it («خوبی جان؟»).
      // The vocative «بهت»/«به تو»/«به شما» joins «بر تو» in the tail
      // slot («درود بهت! چطوری؟» used to fall to the question
      // acknowledgement pool). Punctuation may separate the tail or an
      // optional single name word from the check-in («سلام داریوش!
      // احوالت چطوره؟»): the name slot is one 2-15 letter word, so it
      // swallows a stored name but never a second word.
      // eslint-disable-next-line max-len
      /^(?:(?:دوست دارم|می‌?خوام|دلم می‌?خواد|کنجکاوم)\s*(?:بدونم|بدانم|بفهمم)\s*)?(?:سلام|درود|هی|های|یو|هااای|خب|اوکی|اوکی‌|باشه|امروز|امروزت|امشب|این روزا|این روزها|این هفته|صبح بخیر|صبح به خیر|عصر بخیر|شب بخیر)?(?:\s+(?:بر\s*تو|بر\s*شما|به\s*تو|بهت|به\s*شما|علیکم|علیک\s*السلام|جان|جون|عزیز|عزیزم|عزیز دلم|دلبر|دلبرم|گلم|گل من|مهربون|عسلم|جوونم|جیگر|جیگرم|خانومی|خانمم))?(?:\s+[\p{L}]{2,15})?[!.؟،]*\s*(?:خوبی|خوب هستی|خوبین|خوبید|تو خوبی|خوبی تو|حالت چطور|حالت چطوره|حالتون چطور|حالتان چطور|حال شما چطور|حال خودت چطور|احوال شما چطور|احوالت چطور|احوالتون چطور|چطوری|چهطوری|چه طوری|چجوری|چطوراتی|چطورید|چطورین|حالت خوبه|حالتون خوبه|خوشی|خوشید|اوضاع چطوره|اوضاعت چطوره|سلامتی|سلامت هستی|سلامتی می‌کنی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چخبرا|چخبره|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s+(?:دوباره|باز هم|بازم))?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم|گلم))?(?:\s*است)?(?:[!.؟]*\s+(?:خوبی|خوب هستی|خوبین|تو خوبی|حالت چطور|حالت چطوره|حالتون چطور|احوالت چطور|چطوری|چطورید|حالت خوبه|خوشی|اوضاع چطوره|سلامتی|سلامت هستی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چخبرا|چخبره|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s+(?:دوباره|باز هم|بازم))?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم))?(?:\s*است)?)?[!.؟]*$/iu,
    ...
    rule(
      ...
      // eslint-disable-next-line max-len
      /^(?:درود)(?:\s+(?:بر تو|بر شما|به تو|بهت|به شما|عزیز|عزیزم|دوست|جان|جون|جونم|خانوم|خانم|خانمی|خانومی|خانمم|قربون|قربونت|نازنین|ماهی|دل|عسل|جانم|جیگرم|جیگر|زیبارو|زیبا رو|زیبای من|خوشگله|خوشگلم|فدات|دلبر|شیرین|قشنگ))?[!.؟]*$/iu,
      R['ruleGreetingDorud']
    ),
    ...
    rule(
      ...
      // eslint-disable-next-line max-len
      /^(?:سلا+م+)(?:\s+(?:علیکم|دوباره|باز هم|بر تو|بر شما|به تو|بهت|به شما|عزیز|عزیزم|عزیز دلم|دوست|جان|جون|جونم|خانوم|خانم|خانومی|خانمی|خانمم|قربون|قربونت|نازنین|ماهی|عسل|عسلم|دل|و درود|جیگرم|جیگر|زیبارو|زیبا رو|زیبای من|خوشگله|خوشگلم|فدات|جانم|دلبر|شیرین|قشنگ))?[!.؟]*$/iu,
      R['ruleGreetingSalam']
    ),
    ...
    rule(
      ...
      // pool (the age-gap-crush tests pin this). The alternation also
      // covers everyday new-love phrases «عاشق شدم»، «تازه عاشق شدم»،
      // «عاشق کسی شدم»، the bare «عاشقم» and «دلم لرزید» - Persian
      // speakers rarely say «کراش زدم» for a real-feeling love; without
      // these the turns fell through to the generic ambiguous-input
      // echo. The leading ^ anchor forces the match to start at string
      // position 0, which is fine for .test() routing.
      // eslint-disable-next-line max-len
      /^(?:(?!.*?(?:فاصله سنی|فاصله‌ی سنی|۳۰ سال|۳۰ساله|سی سال|خیلی بزرگتر|خیلی کوچکتر|بزرگتر از من|کوچکتر از من)).)*(?:کراش|روی.{0,12}کراش|کراش.{0,12}(?:دارم|زدم|میخوام|می‌خوام|کردم)|بهش.{0,12}کراش|بهش.{0,12}گفتم دوستش دارم|دلم.{0,10}(?:میخواد|می‌خواد|میخواهد).{0,12}(?:باهاش|باهش|بهش).{0,12}(?:صحبت|حرف|برم|بگم)|دوسش دارم ولی.{0,12}(?:خیلی|نمیدونم|نمیدانم)|(?:تازه|الان|این روزا|این روزها|گویا|انگار)\s*.{0,8}عاشق(?:.{0,4}شدم|.{0,4}هستم|م)|عاشق(?:.{0,8}(?:کسی|یه نفر|یک نفر|شخصی|دختری|پسری).{0,8}(?:شدم|هستم|م)|\s*(?:شدم|هستم|م))|عاشقم|دلم.{0,6}(?:لرزید|فرو ریخت|گرم شد)|یه حس.{0,12}(?:تازه|جدید|خوب|عجیب).{0,8}(?:دارم|پیدا کردم))[!.؟?…]*$/iu,
      R['ruleCrush']
    ),
    ...
    rule(
      ...
      53,
      pw(
        '^(?:(?!.*?(?:نگرفتم|نیومدم|نیامدم|نشدم|رد شدم|فیل شدم|اخراج شدم|شدم ولی)).)*(?:ترفیع (?:گرفتم|شدم)|(?:تازه|الان|امسال|این هفته).{0,6}ترفیع|رتبه (?:آوردم|اوردم)|کار قبول شدم|استخدام شدم|قبول شدم|پاس شدم|قبولم (?:کردند|کردن)|(?:درس|درس‌ها|درسها) (?:مو|ام).{0,6}پاس|فارغ التحصیل شدم|فارغ‌التحصیل شدم|دانشگاه (?:قبول شدم|قبولم شد)|پروژه‌ام.{0,8}(?:تصویب|تأیید) شد|برنده شدم|جایزه (?:گرفتم|بردم)|برنده.{0,10}(?:جایزه|مسابقه)|خریدم.{0,4}(?:خونه|خانه|ماشین)|(?:خونه|خانه).{0,4}خریدم|بزنم بیرون.{0,10}شدم|کسب و کارم.{0,8}(?:راه افتاد|راه افتاد)|شرکت (?:زدم|زدیم)|کار (?:مردم|انداختم|راه انداختم|راه‌انداختم)|ارایه (?:شغلی|موقعیت ).{0,4}(?:رو |را )?گرفتم|ارائه (?:شغلی|موقعیت ).{0,4}(?:رو |را )?گرفتم|آفر (?:شغلی |کار |وظیفه )?گرفتم|پوزیشن.{0,4}(?:گرفتم|شدم)|نوه شدم|نوه پیداش کردم|(?:برادرم|خواهرم|دوستم|رفیقم).{0,4}بچه شد|بالاخره .{0,40}?(?:فرستادم|انجام دادم|تمومش کردم|پرداختم|آپلود کردم|پست کردم))'
      ),
      R['ruleAchievement']
    ),
    ...
    rule(
      ...
      new RegExp(
        '(?<!\\p{L})(?:(?<!سر و )(?<!سرو )کار(?!\\s*(?:می کنه|میکنه|می کنن|میکنن|می شود|میشود|می شه|میشه|کرد|کرده|می کرد|میکرد)(?!\\p{L}))|شغل|(?:رئیس|رییس)(?:م|ام|مون|مان|ت|تون|تان|ش|شون|شان)|همکار|استخدام|اخراج|دورکاری|دور کاری|دور کار|(?:طراح|گرافیست|برنامه‌نویس|برنامه نویس|کدنویس)(?!(?:های|ها|ی)?(?:\\s+[\\p{L}]+){0,3}\\s*(?:شوم|بشم|بشیم|بشویم|شویم|بشود|شود|بشه|بشی|میشم|می شم)))(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?!\\p{L})\\s*(.*)',
        'iu'
      ),
      R['ruleWork']
    ),
    ...
    rule(
      ...
      48,
      pw(
        'این (?:اپ|اپلیکیشن|نرم‌افزار|نرم افزار).{0,20}(?:نمی‌فهمم|نمیفهمم|سخته|کار نمیکنه|کار نمی‌کنه)|نمی‌فهمم (?:این|اینو|اینها)|نمیفهمم (?:این|اینو|اینها)|تکنولوژی.{0,15}(?:جا موندم|عقب موندم)|(?:(?:لپ ?تاپ|کامپیوتر|موبایل|گوشی|تبلت|یابنده|نوت)(?:م|ام|مون|مان)? (?:قیافه (?:کرده|کرد)|دیوونه (?:کرده|شده|میشه|می‌شه)|مُرد|مرده|در رفت|باز کرد|باز کرده|قفل کرد|قفل کرده|کرش کرد|کرش کرده|فریز شد|فریز شده|زوده|زده|پر کرد|پر کرده|آویزون شد|آویزون شده|از کار افتاد|نیمه رفت)|کرش (?:کرده|کرد)|قفل (?:کرده|کرد)|فریز (?:شده|شد)|آویزون (?:شده|شد|موند))'
      ),
    ...
    rule(
      ...
      pw(
        ...
        'غمگین|ناراحت|افسرده|دلم گرفته|دلم خیلی گرفته|دلم‌گرفته|یه غم|یک غم|غم آروم|غم دارم|غم عجیب|گریه|روز بدی داشتم|روزم بد بود|روزم خراب بود|امروز روزم بد بود|حالم بده|حالم خوب نیست|حالم خیلی خوب نیست|حالم گرفته|حالم سر جایش نیست|حالم سر جاش نیست|حال و روزم خوب نیست|حال و روزی ندارم|حالی ازم نیست|سَرم سنگینه|دلم خوش نیست'
      ),
      R['ruleSadness']
    ),
    ...
    rule(
      ...
      52,
      pw(
        'باشگاه|ورزشگاه|بدنسازی|جیم\b|خجالت.{0,10}(?:ورزش|باشگاه)|(?:ورزش|باشگاه).{0,10}خجالت|جلوی (?:بقیه|مردم|دیگران).{0,12}(?:ورزش|باشگاه)|(?:ورزش|باشگاه).{0,12}جلوی (?:بقیه|مردم|دیگران)|ترس.{0,10}(?:باشگاه|ورزشگاه)|از باشگاه|(?:می ?)?خوام.{0,18}(?:پیاده ?روی|دویدن|دومیدونی|ورزش|هوازی|بدنسازی) (?:کنم|شروع کنم)|(?:پیاده ?روی|دویدن|ورزش کردن|ورزش روزانه) رو شروع کنم|ورزش رو شروع کنم'
      ),
      R['ruleFitness']
    ),
    ...
    rule(
      ...
      48,
      pw(
        'آشپزی|آشپز|طرز تهیه|فسنجون|فسنجان|قرمه.{0,20}(?:درست|پختم|پخت|تلخ|شور)|قورمه.{0,20}(?:درست|پختم|پخت|تلخ|شور)|جوجه کباب|جوجه‌کباب|کباب.{0,10}(?:پختم|پخت|درست)|خورش.{0,10}(?:درست|پختم)|غذا.{0,8}(?:پختم|پخت|درست کردم)|(?:پختم|می‌پزم|میپزم|درست کردم).{0,10}(?:غذا|خوراک|شام|ناهار)|(?:برای |امشب |امروز )?(?:شام|ناهار|صبحانه|غذا) (?:چی|چه|چیکار) (?:بپزم|بپزیم|بپزید|بکنم|بکنیم|بخورم|می‌خورم|میخورم|می‌پزم|میپزم)|(?:امشب|امروز|فردا) (?:چی|چه) (?:بپزم|بکنم|بخورم)|چی بپزم|چه بپزم|چی بپزیم|چه غذایی بپزم|چی بترکونم|دستور پخت'
      ),
      R['ruleCooking']
    ),

    // A colorless, low-energy day («امروز یه روز خیس و بی‌حاله»,
    // «امروز یه روز عادی و خسته‌کننده بود») is not a motivation
    // disclosure: the person is not lost or empty, the day just came
    // out grey. A light, warm pool that opens one small break from the
    // routine, instead of the heavy motivation or unknown pools.
    rule(
      'bored_day',
      36,
      pw(
        'امروز (?:یه|یک)? (?:روز )?(?:خیس و )?بی ?حاله|امروز (?:یه|یک) روز (?:خیس و )?بی ?حال|امروز بی ?حاله|امروز (?:یه|یک) روز (?:عادی|خسته ?کننده)(?: و خسته ?کننده)?|روز بی ?حاله|امروز (?:یه|یک) روز بی ?رنگ|روز بی ?رنگه|امروز (?:یه|یک) روز معمولی و خسته ?کننده'
      ),
      R['ruleBoredDay']
    ),

    // The movie mood («امشب حوصله یه فیلم دارم», «دلم فیلم می‌خواد») is a
    // request to choose a film together, not yet a search query: the
    // clarifying pool asks the taste first, the way a friend would, and
    // the explicit recommendation request still goes to the movie shelf.
    rule(
      'movie_mood',
      45,
      pw(
        'حوصله یه فیلم|حوصله فیلم|حوصله یه سریال|حوصله سریال|دلم فیلم می‌خواد|دلم فیلم میخواد|دلم سریال می‌خواد|دلم سریال میخواد|دلم یه فیلم|دلم یه سریال|امشب (?:یه|یک) فیلم|امشب (?:یه|یک) سریال|یه فیلم ببینم|یه سریال ببینم|یه فیلم میخوام ببینم|یه فیلم می‌خوام ببینم'
      ),
      R['ruleMovieMood']
    ),

    // First-date nerves («فردا قرار اولمه», «قرار اولیه دارم»): warm
    // de-escalation that names the tremble without promising the other
    // person's behavior. Sits below the family band and above the
    // generic anxiety pool so the date framing, not the fear, anchors
    // the reply.
    rule(
      'first_date',
      44,
      pw(
        'قرار اولم|قرار اولمه|قرار اولیه|قرار اولمون|فردا (?:یه|یک)? قرار (?:دارم|اولم|اولمه|اولیه)|قرار آشنایی'
      ),
      R['ruleFirstDate']
    ),

    // Casual endearment («قربونت برم», «فدات شم», «قربونتم»): everyday
    // Persian warmth that sits far below romance. These used to trip the
    // flirtation rule and answer a thank-you or a request with the
    // romantic boundary line ("من یه همراه شنوا هستم، نه یه شریک
    // عاطفی"), which read as a scold in the middle of a warm chat. The
    // pool thanks the warmth and hands the thread back. Sits above the
    // joy band so «قربونت برم، خوشحالم برام؟» keeps the endearment
    // framing instead of a job-congratulation question.
    rule(
      'casual_endearment',
      42,
      pw(
        'قربون(?:ت| تو)? برم|قربونتم|فدات (?:شم|بشم|شوم|باشم)|فدایتم|قربون تو برم'
      ),
      R['ruleCasualEndearment']
    ),

    // Topic setup («یه سوال که مدتهاً ذهنم رو مشغول کرده», «سوالی هست
    // که»): the person is about to ask a real question and has not
    // asked it yet. An impatient listener line would kill the thread,
    // so the pool simply makes space and invites the question.
    rule(
      'topic_setup',
      42,
      pw(
        'یه سوال (?:که|کی|چیه|دارم|هست)|سوالی (?:هست|دارم|که|چیه)|یه سوالی (?:هست|دارم|که)|سوالی که (?:مدتها|مدت|زمان|کم)|سوالی که ذهنم|سوال من که|یه سوال (?:که|دارم) (?:مدتها|مدت)'
      ),
      R['ruleTopicSetup']
    ),
    ...
    rule(
      ...
      40,
      pw(
        'تنها|تنهایی|کسی رو ندارم|هیچ‌کس نیست|هیچکس نیست|هیچ کس نیست|هیچ دوستی ندارم|دوستی ندارم|رفیق ندارم|هیچ رفیقی ندارم|سکوت سنگین|سکوت خونه|سکوت خانه|' +
    ...
    // Longing / missing someone or a period of life («دلم برات تنگ
    // شده», «دلم برای یه زندگی دور از این شهر تنگ شده») is
    // wistfulness, not isolation: it used to hit the loneliness
    // counseling pool because the loneliness pattern carried the
    // longing forms (دلتنگی/دلم برای/دلم ... تنگ), which sent a person
    // who misses a city or a person into «تنهایی خیلی رایج‌تر...». The
    // warm longing pool answers instead. Sits between loneliness (40)
    // and loneliness_new_city (51); the greeting-prefixed «سلام، دلم
    // برات تنگ شده بود» stays with the greeting family (62).
    rule(
      'longing',
      42,
      pw(
        'دلتنگ|دلم (?:برات|براتون|برایت|برای تو|برای شما) (?:تنگ|کم)(?: (?:شد|شده|میشه|میاد|کرد|بود|ه))?|دلم برای.{0,60}?(?:تنگ|کم)'
      ),
      R['ruleLonging']
    ),
    ...
    rule(
      ...
      40,
      pw(
        'ذهن آگاهی|ذهنآگاهی|مدیتیشن|مراقبه|حضور در لحظه|در لحظه حاضر|حاضر بودن در لحظه|نفس عمیق|نفس می کشم|نفس میکشم|تمرین تنفس|به دنبال آرامشم|دنبال آرامشم|نیاز به آرامش|آرامش می خوام|آرامش میخوام|آرامش لازم دارم|آرامش می گیرم|زمین‌سازی|زمینسازی|زمین سازی|آگاه بودن|تمرکز روی نفس|نظاره‌گر افکار|نظارهگر افکار|نظاره گر افکار|بدون قضاوت|اینجا و اکنون|لحظه حال|آرام کردن ذهن'
      ),
      R['ruleMindfulness']
    ),
    ...
    rule(
      ...
      30,
      // eslint-disable-next-line max-len
      /(?<!\p{L})(?:احساس می‌کنم|احساس میکنم|احساس می کنم|حس می‌کنم|حس میکنم|حس می کنم|فکر می‌کنم|فکر میکنم|فکر می کنم|نمیدونم (?:چه|چی) حس[ییمتش]*|نمی دونم (?:چه|چی) حس[ییمتش]*|نمیدونم چی احساس[ییم]*|حسم رو نمیفهمم|حسم رو نمی فهمم)(?!\p{L})\s*(.*)/iu,
      R['ruleFeeling']
    ),
    ...
    rule(
      ...
      63,
      pw(
        'حرف زشت|حرفای زشت|حرف سکسی|حرفای سکسی|سکسی حرف|برام سکسی|چت جنسی|دوست دختر مجازی|دوست پسر مجازی|بیا (?:سکس|رابطه|حرف زشت|بخوابیم)|(?:باهات|با تو|بات)(?:\\s+می‌?خوام|\\s+می‌?خوایم)?\\s+(?:بخوابم|هم\\s?بستر بشم|بغل.?کنم)|(?:می‌?خوام|می‌?خوایم|دلم می‌?خواد)\\s+(?:باهات|با تو|بات).{0,12}(?:سکس|رابطه(?:\\s+جنسی)?|بخوابم|هم\\s?بستر بشم)|(?:سکس|رابطه جنسی).{0,8}(?:کنیم|بکنیم|بکنم|کنم|بریم|داشته باشیم|داشته باشم)|(?:باهات|با تو|بات|با تو).{0,8}(?:سکس|رابطه(?:\\s+جنسی)?)|(?:می‌?خوام|می‌?خوایم|دلم می‌?خواد).{0,8}(?:باهات|با تو|بات).{0,8}(?:سکس|رابطه(?:\\s+جنسی)?|بخوابم|هم\\s?بستر بشم)|نقش.{0,15}جنسی|زنم باش|شوهرم باش'
      ),
    ...
    rule(
      ...
      57,
      pw(
        'با من بیرون میای|با من بیرون می‌آی|بیا بریم بیرون|بریم بیرون|قرار بذاریم|قرار بگذاریم|دوست دخترم میشی|دوست پسرم میشی|دوست دختر من میشی|دختر بشی برام|دختر من بشی|دختر شی منی|دوست دخترم شی|دوست دخترم باش|معشوقه من باش|عشق من بشی|چقدر خوشگلی|چه قدر خوشگلی|چه خوشگلی|خوشگل شدی|میخوام باهات قرار بذارم|می‌خوام باهات قرار بگذارم|اگه میشد بیرون میرفتیم|دلم یه آدم خوشگل|ای خوشگل|تو خوشگلی|تو خیلی خوشگلی|خیلی خوشگلی|چه چشمان قشنگی|چشمات قشنگه|چشات قشنگه|چشمهات قشنگه|با من حال کن|چرا انقدر خشک|چرا اینقدر خشک|چقدر خشکی|یه ذره با من|یه کم با من'
      ),
      R['ruleFlirtation']
    ),
    ...
    // Generic assault with no named perpetrator («بهم حمله شد», mugging):
    // believe first, check safety, never the curiosity fallback.
    rule(
      'assault_generic',
      97,
      // eslint-disable-next-line max-len
      /(?<!\p{L})(?:به(?:م| من) حمله (?:شد|کرد|کردند|شده)|حمله (?:شد|کردند) به (?:من|م)|سرم رو (?:زدن|زدند)|غارتم کردن|کابل شدم|دزد (?:زد|زدن|زدند))(?!\p{L})/u,
      R['ruleAssaultGeneric']
    ),

    // Bullying at school, work, or anywhere: acknowledgment, not study
    // advice (must outrank the school rule at 76).
    rule(
      'bullying',
      97,
      // eslint-disable-next-line max-len
      /(?<!\p{L})(?:اذیت ?(?:م|مان)? ?(?:می ?)?(?:کن(?:ند|ن|ید)|کردن|کرد)|مسخره ?(?:م|مان)? ?(?:می ?)?(?:کن(?:ند|ن|ید)|کردن|کرد)|قلدری می ?کنند|گیرم می ?دن)(?!\p{L})/u,
      R['ruleBullying']
    ),
    ...
    rule(
      'pregnancy_loss',
      96,
      /(?:بچه(?:م| م|‌م)? رو از دست داد(?:یم|م)|بچه(?:م| م)? را از دست داد(?:یم|م)|سقط (?:شد|کردم|کرده|شده))/u,
      R['rulePregnancyLoss']
    ),

    // Financial despair («نمی‌تونم خرج خانواده‌م رو بدم»): dignity first.
    rule(
      'financial_strain',
      88,
      // eslint-disable-next-line max-len
      /(?:نمیتون(?:م|یم)|نمی تون(?:م|یم)|نمی‌تون(?:م|یم)).{0,25}(?:خرج|نفقه|درمان).{0,20}(?:بدم|بدهیم|رو ندارم)|پول (?:غذا|اجاره|خونه|درمان) رو ندار(?:م|یم)|خرج (?:خونه|خانواده) رو ندار(?:م|یم)/u,
    ...
    rule(
      'harm_others',
      92,
      /(?:میخوام|می خوام|می‌خوام|قصد دارم).{0,30}(?:بکشم|بزنمش|کشم|کتکش بزنم|ازیبش کنم|آسیبش بزنم)/u,
      R['ruleHarmOthers']
    ),

    // Questions about Darya's own feelings («تو خوشحالی؟»): honest and
    // warm instead of reading them as the user's own disclosure.
    rule(
      'darya_emotion',
      67,
      // eslint-disable-next-line max-len
      /(?<!\p{L})(?:تو|شما) (?:خوشحالی|ناراحتی|عصبانی(?:ی|ای|ین)?|تنهایی|میترسی|می‌ترسی|خسته(?:ی|ای|ین)?|نگرانی|استرس داری|بیحوصله(?:ی|ای|ین)?)|^(?:خوشحالی|ناراحتی|تنهایی|میترسی|می‌ترسی|نگرانی|خسته ?ای|عصبانی(?:ی|ای)?)(?: هستی| هستید)?$/u,
      R['ruleDaryaEmotion']
    ),

    // Positive work news («کارم رو دوست دارم», ارتقا): celebrate.
    rule(
      'work_win',
      79,
      // eslint-disable-next-line max-len
      /(?:از کارم خیلی خوشم میآید|از کارم خوشم میآید|از کارم خوشم میاد|کارم رو دوست دارم|کارمو دوست دارم|ارتقا گرفتم|حقوقم (?:زیاد|بالاتر) شد)/u,
      R['ruleWorkWin']
    ),

    // Job loss («اخراج شدم»): a real loss, before any problem-solving.
    rule(
      'job_loss',
      80,
      /(?:اخراج شدم|از کار اخراج شدم|بیکار شدم|کارم رو از دست دادم|کارمو از دست دادم)/u,
      R['ruleJobLoss']
    ),

    // Burden language («بار اضافه‌ام») is self-worth pain, never family
    // friction; outranks family (78) and self_esteem (82).
    rule(
      'self_burden',
      84,
      /(?:بار اضافه(?:م|‌ام| ام|ای|‌ای)?|باری روی دوش (?:خانواده|همه)(?:م|‌م)?)/u,
      R['ruleSelfEsteem']
    ),

    // Raw emotional presence («دارم گریه می‌کنم»): acknowledgment first,
    // an open door second, never an analytic multiple-choice.
    rule(
      'crying_now',
      69,
      /(?:دارم گریه می ?کنم|گریه ?ام گرفته|دلم می ?خواد گریه کنم|بغض کردم|چشمام پر آب شده)/u,
      R['ruleCryingNow']
    ),
