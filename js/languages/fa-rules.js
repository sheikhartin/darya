...
(function (global) {
  ...
  const rules = [
    ...
    rule(
      ...
      // after it («خوبی جان؟»).
      // eslint-disable-next-line max-len
      /^(?:(?:دوست دارم|می‌?خوام|دلم می‌?خواد|کنجکاوم)\s*(?:بدونم|بدانم|بفهمم)\s*)?(?:سلام|درود|هی|های|یو|هااای|خب|اوکی|اوکی‌|باشه|امروز|امروزت|امشب|این روزا|این روزها|این هفته|صبح بخیر|صبح به خیر|عصر بخیر|شب بخیر)?(?:\s+(?:بر\s*تو|بر\s*شما|علیکم|علیک\s*السلام|جان|جون|عزیز|عزیزم|عزیز دلم|دلبر|دلبرم|گلم|گل من|مهربون|عسلم|جوونم|جیگر|جیگرم|خانومی|خانمم))?\s*(?:خوبی|خوب هستی|خوبین|خوبید|تو خوبی|خوبی تو|حالت چطور|حالت چطوره|حالتون چطور|حالتان چطور|حال شما چطور|حال خودت چطور|احوال شما چطور|احوالت چطور|احوالتون چطور|چطوری|چهطوری|چه طوری|چجوری|چطوراتی|چطورید|چطورین|حالت خوبه|حالتون خوبه|خوشی|خوشید|اوضاع چطوره|اوضاعت چطوره|سلامتی|سلامت هستی|سلامتی می‌کنی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم|گلم))?(?:\s*است)?(?:[!.؟]*\s+(?:خوبی|خوب هستی|خوبین|تو خوبی|حالت چطور|حالت چطوره|حالتون چطور|احوالت چطور|چطوری|چطورید|حالت خوبه|خوشی|اوضاع چطوره|سلامتی|سلامت هستی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم))?(?:\s*است)?)?[!.؟]*$/iu,
