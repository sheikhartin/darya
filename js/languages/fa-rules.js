...
(function (global) {
  ...
  const rules = [
    ...
    rule(
      ...
      // after it («خوبی جان؟»).
      // eslint-disable-next-line max-len
      /^(?:(?:دوست دارم|می‌?خوام|دلم می‌?خواد|کنجکاوم)\s*(?:بدونم|بدانم|بفهمم)\s*)?(?:سلام|درود|هی|های|یو|هااای|خب|اوکی|اوکی‌|باشه|امروز|امروزت|امشب|این روزا|این روزها|این هفته|صبح بخیر|صبح به خیر|عصر بخیر|شب بخیر)?(?:\s+(?:بر\s*تو|بر\s*شما|علیکم|علیک\s*السلام|جان|جون|عزیز|عزیزم|عزیز دلم|دلبر|دلبرم|گلم|گل من|مهربون|عسلم|جوونم|جیگر|جیگرم|خانومی|خانمم))?\s*(?:خوبی|خوب هستی|خوبین|خوبید|تو خوبی|خوبی تو|حالت چطور|حالت چطوره|حالتون چطور|حالتان چطور|حال شما چطور|حال خودت چطور|احوال شما چطور|احوالت چطور|احوالتون چطور|چطوری|چهطوری|چه طوری|چجوری|چطوراتی|چطورید|چطورین|حالت خوبه|حالتون خوبه|خوشی|خوشید|اوضاع چطوره|اوضاعت چطوره|سلامتی|سلامت هستی|سلامتی می‌کنی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چخبرا|چخبره|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s+(?:دوباره|باز هم|بازم))?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم|گلم))?(?:\s*است)?(?:[!.؟]*\s+(?:خوبی|خوب هستی|خوبین|تو خوبی|حالت چطور|حالت چطوره|حالتون چطور|احوالت چطور|چطوری|چطورید|حالت خوبه|خوشی|اوضاع چطوره|سلامتی|سلامت هستی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چخبرا|چخبره|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s+(?:دوباره|باز هم|بازم))?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم))?(?:\s*است)?)?[!.؟]*$/iu,
    ...
    rule(
      ...
      // eslint-disable-next-line max-len
      /^(?:سلا+م+)(?:\s+(?:علیکم|دوباره|باز هم|بر تو|بر شما|عزیز|عزیزم|عزیز دلم|دوست|جان|جون|جونم|خانوم|خانم|خانومی|خانمی|خانمم|قربون|قربونت|نازنین|ماهی|عسل|عسلم|دل|و درود|جیگرم|جیگر|زیبارو|زیبا رو|زیبای من|خوشگله|خوشگلم|فدات|جانم|دلبر|شیرین|قشنگ))?[!.؟]*$/iu,
      R['ruleGreetingSalam']
    ),
    ...
    rule(
      ...
      57,
      pw(
        'با من بیرون میای|با من بیرون می‌آی|بیا بریم بیرون|بریم بیرون|قرار بذاریم|قرار بگذاریم|دوست دخترم میشی|دوست پسرم میشی|دوست دختر من میشی|دختر بشی برام|دختر من بشی|دختر شی منی|دوست دخترم شی|دوست دخترم باش|معشوقه من باش|عشق من بشی|چقدر خوشگلی|چه قدر خوشگلی|چه خوشگلی|خوشگل شدی|قربونت برم|فدات شم|فدات بشم|میخوام باهات قرار بذارم|می‌خوام باهات قرار بگذارم|اگه میشد بیرون میرفتیم|دلم یه آدم خوشگل|ای خوشگل|تو خوشگلی|تو خیلی خوشگلی|خیلی خوشگلی|چه چشمان قشنگی|چشمات قشنگه|چشات قشنگه|چشمهات قشنگه|بیا با هم حرف بزنیم|باهات حرف بزنم|با من حال کن|چرا انقدر خشک|چرا اینقدر خشک|چقدر خشکی|یه ذره با من|یه کم با من'
      ),
      R['ruleFlirtation']
    ),
