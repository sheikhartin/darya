...
(function (global) {
  ...
  const rules = [
    ...
    rule(
      ...
      // eslint-disable-next-line max-len
      /^(?:سلام|درود|هی|خب|اوکی|باشه|امروز|امروزت|امشب|این روزا|این روزها|این هفته)?\s*(?:خوبی|تو خوبی|خوبی تو|حالت چطور|حالتون چطور|حال شما چطور|احوال شما چطور|چطوری|چطورید|حالت خوبه|سلامتی|سلامت هستی|سلامتی می‌کنی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم))?(?:\s*است)?(?:[!.؟]*\s+(?:خوبی|تو خوبی|خوبی تو|حالت چطور|حالتون چطور|حال شما چطور|احوال شما چطور|چطوری|چطورید|حالت خوبه|سلامتی|سلامت هستی|سلامتی می‌کنی|چه خبر|چه خبری|چه خبره|چه خبر ها|چخبر|چ خبر)(?:های|ها|یم|ام|ای|ند|ید|م|ی|ه)?(?:\s*(?:جان|جون|عزیز|عزیزم|دلبر|دلبرم))?(?:\s*است)?)?[!.؟]*$/iu,
