  ...
  const rules = [
    ...
    rule(
      ...
      pw(
        ...
        'پول ندارم|پولی ندارم|پولم نیست|پولم نیس|هیچ پولی ندارم|مشکل مالی|بدهکار|قسط|هزینه‌ها|هزینهها|هزینه ها|پولم تموم شده|پولم تمام شده|بی‌پول|بی پول|بیپول|فلس|فلسم|حقوق|وام|قرض|خرج‌ها|خرج ها|بودجه|مدیریت مالی|مدیریت پول|پس‌انداز|پس انداز|فکرای پول|فکر پول|قیمتا|قیمت ها|قیمتها|تورم|گرونی|خرج‌ها بالا رفته|درآمدم.{0,6}کمه|حقوقم.{0,6}کمه|پول.{0,8}ندارم|پول خرج.{0,10}(?:عذاب وجدان|گناه)|عذاب وجدان.{0,10}(?:پول|خرج)|پول.{0,10}خرج.{0,10}(?:عذاب|گناه)'
      ),
      R['ruleMoney']
    ),
