...
(function (global) {
  ...
  const rules = [
    ...
    rule(
      'online_harassment',
      73,
      /(?:داکس|حمله گروهی|هجوم آنلاین|قلدری سایبری|آزار آنلاین)/u,
    ...
    rule(
      ...
      55,
      // eslint-disable-next-line max-len
      /(?<!\p{L})(?:سقراط|رواقی|رواقی‌گری|رواقی گری|رواقیگری|ارسطو|یونگ|نیچه|گاندی|ماندلا|چرچیل|زرتشت|فلسفه|تمرکز|تمرکز کنم|بهتر یاد بگیرم|بهتر درس بخوانم|ارتباط بهتر|خلاقیت|قفل خلاقیت|مدیریت استرس|استرس|فرسودگی|آرام‌شدن|آرام شدن|آرامشدن|خودشفقتی|مهربانی با خود|منتقد درونی|خودانتقادی|حل تعارض|اختلاف|ارتباط بدون خشونت|تصمیم‌گیری|تصمیم گیری|تصمیمگیری|تصمیم|انتخاب بین|تاب‌آوری|تاب آوری|تابآوری|مقاومت|مقاوم|مقاوم‌تر|مقاومتر|انعطاف‌پذیری|انعطاف پذیری|بازگشت به زندگی|بازگشتن|بخشش|ببخشم|ببخش|بخشیدن|رها کردن|رها کنم|معنای زندگی|معنی زندگی|هدف در زندگی|پیدا کردن هدف|وجودی|معنادار|معنوی|روابط|رابطه|ارتباط عاطفی|شغل|حرفه|پیشرفت شغلی|رضایت شغلی|اضطراب|مدیریت اضطراب|نگرانی|فکر زیاد|ذهن\u200Cآگاهی|ذهن آگاهی|ذهنآگاهی|سوگ|فقدان|بیکار میکنه|بیکار کنه|بیکار میکنن|بیکار کنن|هوش مصنوعی|جایگزین.{0,8}(?:شغل|انسان|کارگر)|طراح‌ها.{0,12}بیکار|نویسنده‌ها.{0,12}بیکار)(?!\p{L})/iu,
      R['ruleKnowledge']
    ),
