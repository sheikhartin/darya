...
(function (global) {
  ...
  const genericFallbacks = [
    ...
    'این حرف جای خوبی برای شروع به ما می‌دهد.',
    'دارم دنبال جزئیاتی می‌گردم که برایت مهم‌تر است.',
    'به نظر می‌رسد این موضوع کمی جا برای مکث می‌خواهد.',
  ];
  ...
  const topicCallbacks = {
    ...
    work: ['نخِ کار هنوز باز است؛ از آن موقع چه چیزی در آن تغییر کرده؟'],
  ...
  global.DaryaLang.fa = {
    ...
    ui: {
      ...
      ariaExportMdLabel: 'دانلود گفت‌وگو به صورت مارک‌داون',
      ariaExportTxtLabel: 'دانلود گفت‌وگو به صورت متن ساده',
