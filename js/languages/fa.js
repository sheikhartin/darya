...
(function (global) {
  ...
  const fa = {
    ...
    ui: {
      ...
      footerTaglines: [
        'دریا همین‌جاست؛ هر وقت خواستی، حرف بزن.',
        'هر وقت یه هم‌صحبت بخوای، من همین‌جام.',
        'از هر جا که خواستی شروع کن؛ گوش می‌دم.',
        'یه نفس عمیق بکش؛ فرصت داریم.',
        'خوشحالم که امروز اینجایی.',
        'یه گفتگوی تازه، یه حس تازه.'
      ],
